...
<div class="row mt-4">
    <div class="col-lg-8 mt-lg-0">
            ...
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-lg-12 col-sm-12 mb-3">
                        ...
                        <input disabled class="form-control" type="text" name="name" id="name" value="{{$estate->name}}" required>
                    </div>
                    @if ($theme == 'theme2')
                    <div class="col-lg-4 col-sm-12">
                        <label>الماركة  :</label>
                        <input class="form-control" type="text" id="estate" value="{{$types->name}}" disabled>
                    </div>
                    <div class="col-lg-4 col-sm-12">
                        <label>نوع السيارة :</label>
                        <input class="form-control" type="text" name="type" id="type" value="{{$estate->type}}" disabled>
                    </div>
                    <div class="col-lg-4 col-sm-12">
                        <label>الموديل :</label>
                        <input class="form-control" type="text" name="model" id="model" value="{{$estate->model}}" disabled>
                    </div>
                    @else
                    <div class="col-lg-4 col-sm-12">
                    ...
                    <div class="col-lg-4 col-sm-12">
                        ...
                        <input class="form-control" type="text" name="goal" id="goal" value="{{$estate->goal}}" disabled>
                    </div>
                    @endif
        ...
        <div class="card card-diver-main diver-props active">
            <div class="card-body">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-12 mb-3">
                        ...
                        <div class="col-sm-6 mb-3">
                            <input class="form-control" type="text" name="colortxt" id="colortxt" value="{{$estate->colortxt}}" placeholder="لون السيارة ...">
                        </div>
                        <div class="col-sm-6 mb-3">
                            <input class="form-control" type="color" name="colorCode" id="colorCode" value="{{$estate->color}}" >
                        </div>    
                        @endif
                    @if ($theme == 'theme1')
                ...
                <div class="col-sm-6 mb-3">
                    ...
                    required
                    >
                    <option value="جديد" @if ($estate->newer == 'جديد')
                        selected
                    @endif>جديد</option>
                    <option value="مستعمل"  @if ($estate->newer == 'مستعمل')
                        selected
                    @endif>مستعمل</option>
                </select>
            </div>
                <div class="col-sm-6 mb-3">
                    ...
                    required
                    >
                    <option value="يدوي" @if ($estate->motor == 'يدوي')
                        selected  @endif>يدوي</option>
                    <option value="أوتوماتيكي" @if($estate->motor == 'أوتوماتيكي')
                        selected  @endif>أوتوماتيكي</option>
                    </select>
                </div>
                    <div class="col-sm-6 mb-3">
                        ...
                        required
                        >
                        <option value="بنزين" @if ($estate->gas == 'بنزين')
                            selected
                        @endif>بنزين</option>
                        <option value="هايبرد" @if ($estate->gas == 'هايبرد')
                            selected
                        @endif>هايبرد</option>
                    </select>
                    </div>
                    ...
                    <div class="col-lg-12 col-sm-12 mb-3">
                        ...
                        <input class="form-control" type="number" name="price" id="price" value="{{$estate->price}}" min="0" required>
                    </div>
                    @else
                    <div class="col-lg-12 col-sm-12 mb-3">
                    ...
                    <div class="col-sm-12 mb-2">
                        ...
                        <div class="form-check form-switch my-auto d-flex align-items-center ml-2">
                            <input class="form-check-input show-ipr" type="checkbox" id="contactprice" name="contactprice"@if ($estate->price ==0)
                                checked
                            @endif >
                        </div>
                    </div>
                    <div class="col-lg-12 col-sm-12 mb-3 ipr-main @if ($estate->price ==0)
                                d-none
                            @endif ">
                        <label>سعر البيع :</label>
                        <input class="form-control form-ipr" type="number" name="price" id="price" value="{{$estate->price}}" min="0" required>
                    </div>
                    {{-- <div class="col-lg-12 col-sm-12 mb-3">
                    ...
                    required
                    >
                    <option value="يقبل تمويل" @if($estate->trade == 'يقبل تمويل')
                        selected  @endif>يقبل تمويل</option>
                    <option value="لا يقبل تمويل" @if($estate->trade == "لا يقبل تمويل")
                        selected  @endif>لا يقبل تمويل</option>
                </select>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        >
                            ...
                            <option {{ $estate->state == 6 ? 'selected' : '' }} value="6">مكة المكرمة</option>
                            ...
                            <option {{ $estate->state == 14 ? 'selected' : '' }} value="14">المدينة المنورة</option>
                            ...
                            <option {{ $estate->state == 168 ? 'selected' : '' }} value="168">الارطاوية</option>
                            ...
                            <option {{ $estate->state == 444 ? 'selected' : '' }} value="444">الروبضة / رغبة</option>
                            ...
                            <option {{ $estate->state == 990 ? 'selected' : '' }} value="990">المزاحمية</option>
                            ...
                            <option {{ $estate->state == 3525 ? 'selected' : '' }} value="3525">ابو عريش</option>
                            <option {{ $estate->state == 3618 ? 'selected' : '' }} value="3618">البديع والقرفي</option>
                            <option {{ $estate->state == 3652 ? 'selected' : '' }} value="3652">احد المسارحة</option>
                            <option {{ $estate->state == 3677 ? 'selected' : '' }} value="3677">الاحساء</option>
                            <option {{ $estate->state == 23695 ? 'selected' : '' }} value="23695">مدينة الملك عبدالله الاقتصادية</option>
                        </select>
                    </div>     
                    <div class="col-sm-12">
            ...
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-sm-12 mb-2">
                        ...
                        <input class="form-control" type="number" name="phone3" id="phone3" placeholder="رقم هاتف ..." value="{{$estate->phone}}">
                    </div>
                    <div class="col-sm-12 mb-2">
                        <label class="mt-2">رابط فيديو</label>
                        <input class="form-control" type="text" name="video" id="video" placeholder="www.youtube.com">
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="file-upload-h mt-3">
                            ...
                            <input type="file" name="is_cover_image" id="is_cover_image" class="form-control custom-input-file-h" value="off">
                        </div>
                        
                            <img id="upcoverImg" class="@if (!$estate->thumbnail_image)
                            hidden
                        @endif" src="{{ getAsset($estate->thumbnail_image,'sd') }}" width="100%" class="mt-2"/>
                    </div>
                    <div class="col-lg-12 col-sm-12 mb-3">
                        <style>.over-img h6{display:none;}</style>
        ...
        <div id="fp" class="row"></div>
                                ...
                                <input type="file" id="FileDetails" class="form-control custom-input-file-h FileDetails"  multiple>
                            </div>
                            </div>
                        </div>
                    </div>
...
<div class="modal fade show" id="create-model" tabindex="-1" aria-hidden="true">
    ...
    <div class="modal-dialog mt-lg-10">
        <div class="modal-content">
            ...
            <input type="hidden" name="_token" value="PnhVIhYczp7nDuU8q3X5yuZa6gZsS1qESYt1v4Eo" autocomplete="off">            <div class="modal-header">
                <h5 class="modal-title" id="ModalLabel">اضافة تصنيف</h5>
            </div>
            <div class="modal-body">
                <p><strong>اسم التصنيف</strong></p>
                <input name="name" type="text" placeholder="اسم التصنيف الجديد..." class="form-control mb-3" onfocus="focused(this)" onfocusout="defocused(this)" required="">
                <p><strong>وصف التصنيف</strong></p>
                <input name="desc" type="text" placeholder="وصف التصنيف الجديد..." class="form-control mb-3" onfocus="focused(this)" onfocusout="defocused(this)">
            </div>
 ...
 state: selectedWilayaId // Send the selected wilaya ID in an array
   ...
   response.forEach(el => {
    ...
    if (el['name_ar'] =="{{$estate->city}}") {
       ...
       $('#choices-state').append('<option '+scv+' value="'+el['name_ar']+'">'+el['name_ar']+'</option>');
   });
...
.then(blob => {
    ...
    var newFile = new File([blob], filename, { type: blob.type, size: blob.size });
...
function addImages() {
    ...
    for (var i = 0; i <= fi.files.length - 1; i++) {
            ...
            // SHOW THE EXTRACTED DETAILS OF THE FILE.
            document.getElementById('fp').innerHTML =
                document.getElementById('fp').innerHTML + '<div class="col-lg-2 col-md-4 ol-sm-12 closer_img" data-r="'+iii+'"><div class="over-img"><h6>' +
                    fname + '</h6><span><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path fill="#ffffff" d="m12 10.586l4.95-4.95l1.415 1.415l-4.95 4.95l4.95 4.95l-1.415 1.414l-4.95-4.95l-4.95 4.95l-1.413-1.415l4.95-4.95l-4.95-4.95L7.05 5.638l4.95 4.95Z"></path></svg>' + fsize.toFixed(2) + ' Mb</span> <div><img  src="'+fimage+'" /></div></div></div>';
        $('.closer_img').click(function () {
            $(this).remove();
            var si = $(this).attr('data-r');
