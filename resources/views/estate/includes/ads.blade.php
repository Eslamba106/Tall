    <div class="col-lg-4 d-none" id="main_ads">
                            ...
                            <div class="card-body px-2 pt-0">
                                <div class="row">
                                    <div class="col-lg-12 col-sm-12">
                                        ...
                                        <img id="upcoverImg" class="@if (!$estate->thumbnail_image) hidden @endif"
                                            src="{{ getAsset($estate->thumbnail_image, 'sd') }}" width="100%"
                                            class="mt-2" />
                                    </div>
