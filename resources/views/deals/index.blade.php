            ...
            <div class="d-lg-flex mt-4 mb-4">
                ...
                <div class="me-auto my-auto mt-lg-0 mt-4">
                    <div class="ms-auto my-auto">
                        <a href="{{ route('deals.create') }}" class="btn bg-gradient-primary btn-sm mb-0">{{ __('طلب جديد') }}
                            +&nbsp; </a>
                                            ...
                                            <div class="input-group" style="padding: 0 30px;">
                                                <div class="content-csa">
                                                    <input type="text" id="search"
                                                        ...
                                                        placeholder="اسم أو رقم الهاتف" name="search"
                                                        @isset($searchKey)
                        value="{{ $searchKey }}"
                        @endisset>
                                        ...
                                        <div class="col-lg-12 col-sm-12">
                                            <ul class="status-row status-row-main">
                                                <li class="status status-ft active" data-status="1"><span
                                                        class="svg-deals"><svg xmlns="http://www.w3.org/2000/svg"
                                                            ...
                                                            <path
                                                                ...
                                                                stroke-width="1.5" stroke-linecap="round"
                                                                stroke-linejoin="round" />
                                                            <path d="M19 15.75H18" stroke-width="1.5" stroke-linecap="round"
                                                                stroke-linejoin="round" />
                                                            <path d="M6 15.75H5" stroke-width="1.5" stroke-linecap="round"
                                                                stroke-linejoin="round" />
                                                            <path d="M18 14V11C18 9.9 17.1 9 16 9H8C6.9 9 6 9.9 6 11V14"
                                                                stroke-width="1.5" stroke-linecap="round"
                                                                stroke-linejoin="round" />
                                                            <path
                                                                ...
                                                                stroke-width="1.5" stroke-linecap="round"
                                                                stroke-linejoin="round" />
                                                        </svg></span><span class="ccontent-d"><span class="status-txt">كل
                                                            الطلبات</span><span
                                                            class="nump">{{ $estates0 }}</span></span></li>
                                                <li class="status" data-status="1"><span class="svg-deals"><svg
                                                            style="fill: none;stroke: #32a466;"
                                                            ...
                                                            <path d="M2.62 11.27C4.87 12.81 7.41 13.74 10 14.03"
                                                                stroke-width="1.5" stroke-miterlimit="10"
                                                                stroke-linecap="round" stroke-linejoin="round" />
                                                        </svg></span><span class="ccontent-d"><span class="status-txt">طلب
                                                            جديد</span><span
                                                            class="nump">{{ $estates1 }}</span></span></li>
                                                <li class="status status-inv" data-status="3"><span class="svg-deals"><svg
                                                        ...
                                                        </svg></span><span class="ccontent-d"><span
                                                            class="status-txt">المفاوضات</span><span
                                                            class="nump">{{ $estates3 }}</span></span></li>
                                                <li class="status" data-status="4"><span class="svg-deals"><svg
                                                            style="fill: none;stroke: #32a466;"
                                                            xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
                                                            fill="none">
                                                            <path
                                                            ...
                                                            <path d="M8 6V5.2C8 3.43 8 2 11.2 2H12.8C16 2 16 3.43 16 5.2V6"
                                                                stroke-width="1.5" stroke-miterlimit="10"
                                                                stroke-linecap="round" stroke-linejoin="round" />
                                                            <path d="M21.65 11C19.92 12.26 18 13.14 16.01 13.64"
                                                                stroke-width="1.5" stroke-miterlimit="10"
                                                                stroke-linecap="round" stroke-linejoin="round" />
                                                            <path d="M2.62 11.27C4.29 12.41 6.11 13.22 8 13.68"
                                                                stroke-width="1.5" stroke-miterlimit="10"
                                                                stroke-linecap="round" stroke-linejoin="round" />
                                                        </svg></span><span class="ccontent-d"><span class="status-txt">تمت
                                                            البيعة</span><span
                                                            class="nump">{{ $estates4 }}</span></span></li>
                                                <li class="status" data-status="5"><span class="svg-deals"><svg
                                                            style="fill: none;stroke: #32a466;"
                                                            xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
                                                            fill="none">
                                                            <path
                                                                ...
                                                                stroke-width="1.5" stroke-miterlimit="10"
                                                                stroke-linecap="round" stroke-linejoin="round" />
                                                            <path d="M13.07 15.31L10.95 13.2" stroke-width="1.5"
                                                                stroke-miterlimit="10" stroke-linecap="round"
                                                                stroke-linejoin="round" />
                                                            <path d="M13.0501 13.22L10.9301 15.34" stroke-width="1.5"
                                                                stroke-miterlimit="10" stroke-linecap="round"
                                                                stroke-linejoin="round" />
                                                            <path
                                                                d="M7.99995 22H15.9999C20.0199 22 20.7399 20.39 20.9499 18.43L21.6999 10.43C21.9699 7.99 21.2699 6 16.9999 6H6.99995C2.72995 6 2.02995 7.99 2.29995 10.43L3.04995 18.43C3.25995 20.39 3.97995 22 7.99995 22Z"
                                                            ...
                                                            class="status-txt">الغية البيعة</span><span
                                                            class="nump">{{ $estates5 }}</span></span></li>
                                            </ul>
                                        </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <h6 class="mr-2 ms-3 my-auto">
                                                    {{ date('d-m-Y', strtotime($deal->created_at)) }}</h6>
                                            </td>
                                            <td>
                            ...
                            <div class="d-flex align-items-center justify-content-between py-3 px-4">
                                <span class="smaller">يتم عرض
                                    {{ $deals->firstItem() }} {{ __('الى') }} {{ $deals->lastItem() }}
                                    {{ __('من') }}
