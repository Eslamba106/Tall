...
<head>
    ...
    <!-- Favicon -->
    {{-- <link rel="shortcut icon" href="{{asset('storage/app/company/'.$web_config['fav_icon']->value)}}"> --}}
...
@include('dash.layouts.back-end.partials._header')
@include('dash.layouts.back-end.partials._side-bar')
...
<main id="content" role="main" class="main pointer-event">
    ...
    <!-- Footer -->
    @include('dash.layouts.back-end.partials._footer')
    <!-- End Footer -->

    @include('dash.layouts.back-end.partials._modals')

    {{-- Toggle Modal --}}
    @include('dash.layouts.back-end.partials._toggle-modal')
</main>
<!-- ========== END MAIN CONTENT ========== -->
