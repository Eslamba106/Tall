    ...
    <div class="row justify-content-between align-items-center">
        <div class="col-lg-4 mb-3 mb-lg-0">
            <p class="font-size-sm mb-0 title-color text-center text-lg-left">
                &copy; {{\App\Models\BusinessSetting::where(['type'=>'company_name'])->first()->value ?? null}}. <span
                    class="d-none d-sm-inline-block">copy right Tall@2025</span>
                    {{-- class="d-none d-sm-inline-block">{{\App\Models\BusinessSetting::where(['type'=>'company_copyright_text'])->first()->value ?? null}}</span> --}}
            </p>
        </div>
        <div class="col-lg-8">
