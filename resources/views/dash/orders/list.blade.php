                    ...
                    <div class="px-3 py-4">
                        <div class="row align-items-center">
                            ...
                            {{-- <div class="col-lg-4 mt-3 mt-lg-0 d-flex flex-wrap gap-3 justify-content-lg-end"> --}}
                                ...
                                {{-- @can('create_tenant') --}}
                                    <a href="{{ route('order.create') }}" class="btn color_primary">
                                        <i class="tio-add"></i>
                                ...
                                @foreach ($orders as $k => $order)
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            {{   ($order->customer->name ?? __('general.not_available'))  }}
                                        </td>
                                        <td class="text-center">
                                            {{ $order->ads->name ?? __('general.not_available')}}
                                        </td>
                                        <td class="text-center">
                                            {{ $order->created_at ?? __('general.not_available')}}
                                        </td>
