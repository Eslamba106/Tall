...
@section('content')
    ...
    ">
        ...
        @if (is_array($getTheme) && $getTheme[1]->section_enable == 'on')
                            ...
                            <div class="col-auto-main col-auto-main-r">
                                    ...
                                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20"
                                        ...
                                        <g clip-path="url(#clip0_14_139)">
                                            ...
                                            <path fill-rule="evenodd" clip-rule="evenodd"
                                                d="M5 7.5C5 4.73857 7.23857 2.5 10 2.5C12.7614 2.5 15 4.73857 15 7.5C15 10.2614 12.7614 12.5 10 12.5C7.23857 12.5 5 10.2614 5 7.5Z"
                                                fill="black" />
                                            <path
                                                d="M5.92485 11.6739L5.12187 14.0828C4.40594 16.2306 6.68547 18.1479 8.67883 17.0746L9.605 16.5758C9.85167 16.443 10.1486 16.443 10.3952 16.5758L11.3214 17.0746C13.3147 18.1479 15.5943 16.2306 14.8783 14.0828L14.0753 11.6736C13.0238 12.7005 11.5858 13.3333 9.99992 13.3333C8.41425 13.3333 6.97631 12.7006 5.92485 11.6739Z"
                                                fill="black" />
                                        </g>
                                        <defs>
                                ...
                                <div class="icon-svg-filter00">
                                    ...
                                    <div class="icon-svg-filter0">
                                        <svg style="stroke: #a5b0af;fill: transparent;" xmlns="http://www.w3.org/2000/svg"
                                            viewBox="0 0 24 24" id="Layer_1" data-name="Layer 1">
                                            <path class="cls-1"
                                                d="M2.45,17.73H7.23a0,0,0,0,1,0,0v2.86a1,1,0,0,1-1,1H3.41a1,1,0,0,1-1-1V17.73A0,0,0,0,1,2.45,17.73Z" />
                                            <path class="cls-1"
                                                d="M16.77,17.73h4.77a0,0,0,0,1,0,0v2.86a1,1,0,0,1-1,1H17.73a1,1,0,0,1-1-1V17.73A0,0,0,0,1,16.77,17.73Z" />
                                            <path class="cls-1"
                                                d="M5.32,9.14H18.68A3.82,3.82,0,0,1,22.5,13v4.77a0,0,0,0,1,0,0H1.5a0,0,0,0,1,0,0V13A3.82,3.82,0,0,1,5.32,9.14Z" />
                                            <path class="cls-1"
                                                d="M16.29,2.45H7.71A1.91,1.91,0,0,0,5.88,3.84L4.36,9.14H19.64l-1.52-5.3A1.91,1.91,0,0,0,16.29,2.45Z" />
                                            <circle class="cls-2" cx="4.84" cy="13.43" r="1.43" />
                                            <circle class="cls-2" cx="19.16" cy="13.43" r="1.43" />
                                            <path class="cls-1" d="M14.86,13.91h0Z" />
                                            <line class="cls-1" x1="22.5" y1="7.23" x2="19.09"
                                                y2="7.23" />
                                            <line class="cls-1" x1="4.91" y1="7.23" x2="1.5"
                                                y2="7.23" />
                                        </svg>
                                    </div>
                                    ...
                                    @php
                                        ...
                                        $estateCounts = App\Models\Estate::select(
                                            'estatetxt',
                                    ...
                                    <select value="{{ old('type') }}" class="form-control" data-trigger name="type"
                                        placeholder="الماركا" id="choices-type0" class="content-filter-part-tt" required>
                                        ...
                                        @foreach ($carBrands as $brand)
                                            ...
                                            @if ($count == 0)
                                                @continue
                                            @endif
                                            <option value="{{ $brand }}">{{ $brand }} <span
                                                    class="number-of">({{ $count }})</span></option>
                                        @endforeach
                                    </select>
                                </div>
                                {{-- <select
                ...
                <option value="تجاري">تجاري</option>
                            ...
                            <div class="col-auto-main col-auto-main-r">
                                <div class="title-filter">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18"
                                        ...
                                        <path
                                            d="M16.3125 5.9986C16.3125 6.30609 16.0575 6.5611 15.75 6.5611H2.25C1.9425 6.5611 1.6875 6.30609 1.6875 5.9986C1.6875 5.6911 1.9425 5.4361 2.25 5.4361H3.015L3.3 4.0786C3.57 2.7661 4.1325 1.55859 6.3675 1.55859H11.6325C13.8675 1.55859 14.43 2.7661 14.7 4.0786L14.985 5.4361H15.75C16.0575 5.4361 16.3125 5.6911 16.3125 5.9986Z"
                                            fill="black" />
                                        <path
                                            d="M16.6362 10.245C16.5237 9.0075 16.1936 7.6875 13.7861 7.6875H4.21616C1.80866 7.6875 1.48616 9.0075 1.36616 10.245L0.946163 14.8125C0.893663 15.3825 1.08116 15.9525 1.47116 16.38C1.86866 16.815 2.43116 17.0625 3.03116 17.0625H4.44116C5.65616 17.0625 5.88866 16.365 6.03866 15.9075L6.18866 15.4575C6.36116 14.94 6.40616 14.8125 7.08116 14.8125H10.9212C11.5962 14.8125 11.6187 14.8875 11.8137 15.4575L11.9637 15.9075C12.1137 16.365 12.3462 17.0625 13.5612 17.0625H14.9711C15.5637 17.0625 16.1337 16.815 16.5312 16.38C16.9212 15.9525 17.1087 15.3825 17.0562 14.8125L16.6362 10.245ZM6.75116 11.8125H4.50116C4.19366 11.8125 3.93866 11.5575 3.93866 11.25C3.93866 10.9425 4.19366 10.6875 4.50116 10.6875H6.75116C7.05866 10.6875 7.31366 10.9425 7.31366 11.25C7.31366 11.5575 7.05866 11.8125 6.75116 11.8125ZM13.5012 11.8125H11.2512C10.9437 11.8125 10.6887 11.5575 10.6887 11.25C10.6887 10.9425 10.9437 10.6875 11.2512 10.6875H13.5012C13.8087 10.6875 14.0637 10.9425 14.0637 11.25C14.0637 11.5575 13.8087 11.8125 13.5012 11.8125Z"
                                            fill="black" />
                                    </svg>
                                    <h4 class="sub-title-filtter">
                                        نوع السيارة :
                            ...
                            <div class="col-auto-main col-auto-main-r">
                                ...
                                <div class="icon-svg-filter00">
                                    ...
                                    <select value="{{ old('city') }}" class="form-control" data-trigger name="model"
                                        placeholder="الموديل" id="choices-state0" class="content-filter-part-tt"
                                        required>
                            ...
                            <div class="col-auto-main col-auto-main-r">
                                ...
                                <div class="title-filter">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18"
                                        viewBox="0 0 18 18" fill="none">
                                        <path d="M3.75 12.75H9.75M3.75 9H14.25M8.25 5.25H14.25" stroke="black"
                                    ...
                                    <div class="icon-svg-filter0">
                                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none">
                                            <path
                                                ...
                                                stroke="#a5b0af" stroke-width="1.5" stroke-linecap="round"
                                                stroke-linejoin="round" />
                                        </svg>
                                    </div>
                                    <select value="{{ old('city') }}" class="form-control" data-trigger name="model"
                                        placeholder="الحالة" id="choices-type1" class="content-filter-part-tt" required>
                                        @php
                                            $count1 = App\Models\Estate::where('newer', 'جديد')->count();
                                            $count2 = App\Models\Estate::where('newer', 'مستعمل')->count();
                                        @endphp
                                        <option value="">الحالة</option>
                                        <option value="0">مستعمل <span
                                                class="number-of">({{ $count2 }})</span></option>
                                        <option value="1">جديد <span class="number-of">({{ $count1 }})</span>
                                        </option>
                                    </select>
                                </div>
                            </div>
            ...
            <div class="container-fluid container-fluid-phone" style="padding-left: 1.5em;padding-right: 1.5em;">
                <div class="container-bg">
                    <h2 class="content-h2">أفضل السيــــــارات !.</h2>
                    <div class="row">
                        @php
                                            ...
                                            @foreach ($estates as $estate)
                                                <div class="col-md-6">
                                                    <div class="card d-flex flex-row row">
                                                        ...
                                                        <div class="col-md-6">
                                                            <img class="  border border-2 border-primary rounded"
                                                                src="{{ asset('uploads/cars1.jpeg') }}" alt="img"
                                                                style="object-fit: cover; width: 100%; height: 100%;">

                                                            {{-- <a href="blog-details.html"> --}}
                                                            {{-- <img class="  "
                                                                    src="{{ asset('uploads/cars1.jpeg') }}"
                                                                    alt="img"
                                                                    style="object-fit: cover; width: 100%; height: 100%;"> --}}
                                                            {{-- </a>  --}}
                                                        </div>
                                                        <div class="card-body d-flex flex-column col-md-6">
                                                            <h5><a href="blog-details.html">Email Hosting For Your
                                                                    Projects</a></h5>
                                                            <div class="tx-muted">At vero eos et accusamus et iusto odio
                                                            ...
                                                            <div class="d-flex align-items-center pt-4 mt-auto">
                                                                ...
                                                                <div>
                                                                    <a href="javascript:void(0);" class="h6">Mike
                                                                        Rowe-Soft</a>
                                                    ...
                                                    <div class="card">
                                                        ...
                                                        <div class="card-body d-flex flex-column">
                                                            ...
                                                            <div class="d-flex align-items-center pt-4 mt-auto">
                                                                ...
                                                                <div class="ms-auto">
                                                                    <a href="javascript:void(0)"
                                                                        class="icon d-inline-block tx-muted"><i
                                                        ...
                                                        @if ($estates->hasMorePages())
                                                            <li class="page-item">
                                                                <a class="page-link page-link-t"
                                                                    ...
                                                                    aria-label="@lang('pagination.next')">التالي
                                                                    ›</a>
                                                            </li>
                                                        @else
