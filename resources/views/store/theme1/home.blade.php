...
@section('page-title'){{ __('الرئيسية') }} 
@endsection
...
@endphp
    ...
    <div class="swiper-button swiper-button-next"><svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 18 18" fill="none">
    ...
    <div class="swiper-button swiper-button-prev"><svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 18 18" fill="none">
        <path d="M10.7171 13.7208C10.4242 14.0137 9.94929 14.0137 9.65642 13.7208L5.99086 10.0516C5.40556 9.46571 5.40579 8.51636 5.99132 7.93076L9.65912 4.26304C9.95199 3.97009 10.4269 3.97009 10.7198 4.26304C11.0127 4.55591 11.0127 5.03081 10.7198 5.32369L7.58056 8.46289C7.28761 8.75576 7.28769 9.23066 7.58056 9.52354L10.7171 12.6601C11.01 12.953 11.01 13.4279 10.7171 13.7208Z" fill="white"/>
      </svg></div>
</div>
            ...
            {{-- <div class="filter-part">
                ...
                <div class="completing-filter">
                    <div class="col-auto-main col-auto-main-r">
                        <div class="filter-main-s">
                            <div class="title-filter">
                                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
                                    ...
                                    <path d="M1.6665 10.1698C1.6665 8.26274 1.6665 7.30924 2.09917 6.51879C2.53184 5.72834 3.3223 5.23776 4.90319 4.25661L6.56986 3.22223C8.24099 2.18508 9.07659 1.6665 9.99984 1.6665C10.9231 1.6665 11.7587 2.18508 13.4298 3.22223L15.0965 4.2566C16.6774 5.23776 17.4678 5.72834 17.9005 6.51879C18.3332 7.30924 18.3332 8.26274 18.3332 10.1698V11.4373C18.3332 14.688 18.3332 16.3134 17.3568 17.3233C16.3806 18.3332 14.8092 18.3332 11.6665 18.3332H8.33317C5.19047 18.3332 3.61913 18.3332 2.64281 17.3233C1.6665 16.3134 1.6665 14.688 1.6665 11.4373V10.1698Z" stroke="black" stroke-width="1.5"/>
                                    <path d="M7.5 13.333C8.20865 13.8583 9.0705 14.1663 10 14.1663C10.9295 14.1663 11.7913 13.8583 12.5 13.333" stroke="black" stroke-width="1.5" stroke-linecap="round"/>
                                    </g>
                                    <defs>
                        ...
                        <div class="ce"><div class="content-form-filter">أدخل نوع العقار هنا ...</div><div class="svg-filter"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none">
                            ...
                            <div class="filter-content-main">
                                <div class="content-filt">
                                    <div class="part-tgs">
                                        <span class="list-main-flt active" data-type='تجاري' data-id='0'>تجاري</span>
                                        <span class="list-main-flt" data-type='سكني' data-id='1'>سكني</span>
                                    </div>
                                    <div class="part-tgt part-tgt-0 active">
                                        <span class="list-main-sqt" data-type="0"><span class="fh-f">الكل</span></span>
                                        <span class="list-main-sqt" data-type="2"><span class="fh-f">أرض</span></span>
                                        <span class="list-main-sqt" data-type="2"><span class="fh-f">مزرعة</span></span>
                                        <span class="list-main-sqt" data-type="2"><span class="fh-f">استراحة</span></span>
                                        <span class="list-main-sqt" data-type="2"><span class="fh-f">شقة</span></span>
                                        <span class="list-main-sqt" data-type="2"><span class="fh-f">دور</span></span>
                                        <span class="list-main-sqt" data-type="2"><span class="fh-f">دوبلكس</span></span>
                                        <span class="list-main-sqt" data-type="2"><span class="fh-f">فيلا</span></span>
                                        <span class="list-main-sqt" data-type="2"><span class="fh-f">قصر</span></span>
                                        <span class="list-main-sqt" data-type="2"><span class="fh-f">شاليه</span></span>
                                        <span class="list-main-sqt" data-type="2"><span class="fh-f">غرفة</span></span>
                                        <span class="list-main-sqt" data-type="2"><span class="fh-f">استديو</span></span>
                                    </div>
                                    <div class="part-tgt part-tgt-1">
                                        <span class="list-main-sqt" data-type="0"><span class="fh-f">مزرعة</span></span>
                                        <span class="list-main-sqt" data-type="2"><span class="fh-f">استراحة</span></span>
                                        <span class="list-main-sqt" data-type="2"><span class="fh-f">عمارة</span></span>
                                        <span class="list-main-sqt" data-type="2"><span class="fh-f">محل تجاري</span></span>
                                        <span class="list-main-sqt" data-type="2"><span class="fh-f">مكتب تجاري</span></span>
                                        <span class="list-main-sqt" data-type="2"><span class="fh-f">مستودع</span></span>
                                        <span class="list-main-sqt" data-type="2"><span class="fh-f">شاليه</span></span>
                                        <span class="list-main-sqt" data-type="2"><span class="fh-f">محطة بنزين</span></span>
                                    </div>
                    ...
                    <div class="col-auto-main col-auto-main-r">
                        <div class="title-filter">
                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
                                <path d="M4.75604 13.4468C4.4306 13.7722 4.4306 14.2999 4.75604 14.6253L8.83286 18.6981C9.48386 19.3484 10.5387 19.3482 11.1894 18.6976L15.2646 14.6223C15.5901 14.2969 15.5901 13.7692 15.2646 13.4438C14.9392 13.1184 14.4115 13.1184 14.0861 13.4438L10.5981 16.9318C10.2727 17.2573 9.74503 17.2573 9.41961 16.9318L5.93455 13.4468C5.60911 13.1214 5.08147 13.1214 4.75604 13.4468Z" fill="#0F0F0F"/>
                                <path d="M15.2646 6.57246C15.5901 6.24702 15.5901 5.71939 15.2646 5.39395L11.1878 1.32107C10.5368 0.670745 9.48204 0.671003 8.83137 1.32165L4.75604 5.39696C4.4306 5.72239 4.4306 6.25003 4.75604 6.57546C5.08148 6.90091 5.60912 6.90091 5.93455 6.57546L9.42262 3.08743C9.74804 2.76199 10.2757 2.76199 10.6011 3.08743L14.0861 6.57246C14.4115 6.8979 14.9392 6.8979 15.2646 6.57246Z" fill="#0F0F0F"/>
                                </svg>
                            <h4 class="sub-title-filtter">
                                للبيع/للايجار :
                            </h4>
                        ...
                        <option value="للبيع" >للبيع      <span class="number-of">({{$estateSell}})</span></option>
                        <option value="ايجار">للايجار      <span class="number-of">({{$estateRent}})</span></option>
                        </select>
                    </div>
                    <div class="col-auto-main col-auto-main-r">
...
@endphp
<option value="3">الرياض<span class="number-of">({{$number}})</span></option>
@endif
...
@endphp
<option value="6">مكة المكرمة<span class="number-of">({{$number}})</span></option>
@endif
...
@endphp
<option value="23695">مدينة الملك عبدالله الاقتصادية({{$number}})</option>
@endif
</select>
                    </div>
...
<div class="title-filter">
 ...
 <a href="{{route('products',$estate->id)}}" class="link-pov"></a>
                                            ...
                                            <div class="bottom">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 14 14" fill="none">
                                                    ...
                                                    <g id="style=linear">
                                                    <g id="location">
                                                    <path id="vector" d="M5.3542 11.8481C5.40035 11.8933 5.44594 11.9378 5.4909 11.9815C5.50184 11.9921 5.51275 12.0026 5.52361 12.013M5.3542 11.8481C3.76216 10.2879 1.50888 7.8322 2.15501 4.95234C3.29395 -0.099328 10.7115 -0.093494 11.8447 4.95817C12.5095 7.9215 10.1045 10.4298 8.50303 11.9815C7.35182 13.1026 6.6716 13.1131 5.52361 12.013M5.3542 11.8481L5.52361 12.013" stroke="#484848" stroke-width="1.5"/>
                                                    <path id="ellipse" d="M6.99984 6.99968C7.80525 6.99968 8.45817 6.34676 8.45817 5.54134C8.45817 4.73593 7.80525 4.08301 6.99984 4.08301C6.19442 4.08301 5.5415 4.73593 5.5415 5.54134C5.5415 6.34676 6.19442 6.99968 6.99984 6.99968Z" stroke="#484848" stroke-width="1.5"/>
                                                    </g>
                                                    </g>
                                                    </g>
                                                    </g>
                                            ...
                                            <ul class="meta-list">
                                                ...
                                                height: 18px;" xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 18 18" fill="none">
                                                    <g clip-path="url(#clip0_78_522)">
                                                      <path d="M2.25 5.25C2.25 5.66421 1.91421 6 1.5 6C1.08579 6 0.75 5.66421 0.75 5.25V2.25C0.75 1.42157 1.42157 0.75 2.25 0.75H5.25C5.66421 0.75 6 1.08579 6 1.5C6 1.91421 5.66421 2.25 5.25 2.25H3.31066L8.03032 6.96967C8.3232 7.26256 8.3232 7.73745 8.03032 8.03032C7.73745 8.3232 7.26256 8.3232 6.96967 8.03032L2.25 3.31066V5.25Z" fill="#0F0F0F"/>
                                                      <path d="M15.75 12.75C15.75 12.3358 16.0858 12 16.5 12C16.9142 12 17.25 12.3358 17.25 12.75V15.75C17.25 16.5784 16.5784 17.25 15.75 17.25H12.75C12.3358 17.25 12 16.9142 12 16.5C12 16.0858 12.3358 15.75 12.75 15.75H14.6893L9.96966 11.0303C9.67678 10.7374 9.67678 10.2625 9.96966 9.96966C10.2625 9.67678 10.7374 9.67678 11.0303 9.96966L15.75 14.6893V12.75Z" fill="#0F0F0F"/>
                                                      <path d="M15.75 5.25C15.75 5.66421 16.0858 6 16.5 6C16.9142 6 17.25 5.66421 17.25 5.25V2.25C17.25 1.42157 16.5784 0.75 15.75 0.75H12.75C12.3358 0.75 12 1.08579 12 1.5C12 1.91421 12.3358 2.25 12.75 2.25H14.6893L9.96966 6.96967C9.67678 7.26256 9.67678 7.73745 9.96966 8.03032C10.2625 8.3232 10.7374 8.3232 11.0303 8.03032L15.75 3.31066V5.25Z" fill="#0F0F0F"/>
                                                      <path d="M2.25 12.75C2.25 12.3358 1.91421 12 1.5 12C1.08579 12 0.75 12.3358 0.75 12.75V15.75C0.75 16.5784 1.42157 17.25 2.25 17.25H5.25C5.66421 17.25 6 16.9142 6 16.5C6 16.0858 5.66421 15.75 5.25 15.75H3.31066L8.03032 11.0303C8.3232 10.7374 8.3232 10.2625 8.03032 9.96966C7.73745 9.67678 7.26256 9.67678 6.96967 9.96966L2.25 14.6893V12.75Z" fill="#0F0F0F"/>
                                                    </g>
                                                    <defs>
                                                ...
                                                <li class="item">
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="24"  height="24" viewBox="0 0 24 24" fill="none">
                                                        <path d="M2 12.2039C2 9.91549 2 8.77128 2.5192 7.82274C3.0384 6.87421 3.98695 6.28551 5.88403 5.10813L7.88403 3.86687C9.88939 2.62229 10.8921 2 12 2C13.1079 2 14.1106 2.62229 16.116 3.86687L18.116 5.10812C20.0131 6.28551 20.9616 6.87421 21.4808 7.82274C22 8.77128 22 9.91549 22 12.2039V13.725C22 17.6258 22 19.5763 20.8284 20.7881C19.6569 22 17.7712 22 14 22H10C6.22876 22 4.34315 22 3.17157 20.7881C2 19.5763 2 17.6258 2 13.725V12.2039Z" stroke="black" stroke-width="1.5"/>
                                                        <path d="M15 18H9" stroke="black" stroke-width="1.5" stroke-linecap="round"/>
                                                      </svg>
                                                      <div class="prop-cont">
                                                    <span class="text-variant-1">نوع العقار :</span>
                                                    <span class="fw-6">{{$estate->type}}</span></div>
                                                </li>
                                                </ul>
    ...
    const selectedWilayaId = parseInt($('#choices-city0').val());
     ...
     $.post("{{ route('estate.state') }}", {
      ...
      state: selectedWilayaId // Send the selected wilaya ID in an array
        ...
        $('#choices-state0').html('');
        response.forEach(el => {
            $('#choices-state0').append('<option value="'+el['name_ar']+'">'+el['name_ar']+'</option>');
        });
