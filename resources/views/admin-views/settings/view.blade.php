                                ...
                                @foreach(json_decode($language) as $lang)
                                    <li class="nav-item text-capitalize">
                                        <a class="nav-link lang_link {{$lang == $default_lang? 'active':''}}"
                                           href="#"
                                           id="{{$lang}}-link">{{ucfirst(\App\Http\Helpers\Translation::get_language_name($lang)).'('.strtoupper($lang).')'}}</a>
                                    </li>
                                @endforeach
                            </ul>
                            <div class="row">
                                <div class="col-lg-6">
                                    <div>
                                        ...
                                        <div class="form-group {{$lang != $default_lang ? 'd-none':''}} lang_form"
                                            id="{{$lang}}-form">
                                            <label class="title-color">{{translate('estate_Product_Name')}}<span class="text-danger">*</span> ({{strtoupper($lang)}})</label>
                                            <input type="text" name="name[]" class="form-control"
                                                placeholder="{{translate('new_estate_product')}}" {{$lang == $default_lang? 'required':''}}>
                                        </div>_
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <img class="rounded" width="64"
                                                ...
                                                src="{{asset('storage/app/category')}}/{{$category['icon']}}">
                                    </td>
                                    ...
                                    <td class="text-center">
                                        ...
                                        <form action="" method="post" id="category_status{{$category['id']}}_form" class="category_status_form">
                                            @csrf
