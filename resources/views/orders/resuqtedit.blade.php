            ...
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-lg-6 col-sm-12 mb-3">
                        ...
                        <input class="form-control" type="text" name="name" id="name" value="{{$order->username}}" required>
                    </div>
                    <div class="col-lg-6 col-sm-12 mb-3">
                        <label>رقم الهاتف :</label>
                        <input dir="ltr" class="form-control" type="text" name="phone" id="phone" value="{{$order->phone}}" required>
                    </div>
                    @if ( $theme == 'theme1')
                    <div class="col-lg-4 col-sm-12">
                        <label>نوع العقار :</label>
                        <input class="form-control" type="text" name="type" id="type" value="{{$order->type}}" disabled>
                    </div>
                    <div class="col-lg-4 col-sm-12">
                        <label>المعاملة :</label>
                        <input class="form-control" type="text" name="goal" id="goal" value="{{$order->goal}}" disabled>
                    </div>
                    <div class="col-lg-4 col-sm-12">
                        <label>
                            المنتج العقاري :</label>
                        <input class="form-control" type="text" name="estate" id="estate" value="{{$order->estate}}" disabled>
                    </div>
                    @else
                    <div class="col-lg-4 col-sm-12">
                        <label>الماركة :</label>
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        required
                        >
                        <option {{ $order->state == 3 ? 'selected' : '' }} value="3">الرياض</option>
                        <option {{ $order->state == 5 ? 'selected' : '' }} value="5">الطائف</option>
                        <option {{ $order->state == 6 ? 'selected' : '' }} value="6">مكة المكرمة</option>
                        <option {{ $order->state == 10 ? 'selected' : '' }} value="10">حائل</option>
                        <option {{ $order->state == 11 ? 'selected' : '' }} value="11">بريدة</option>
                        <option {{ $order->state == 13? 'selected' : '' }} value="13">الدمام</option>
                        <option {{ $order->state == 14 ? 'selected' : '' }} value="14">المدينة المنورة</option>
                        <option {{ $order->state == 15 ? 'selected' : '' }} value="15">ابها</option>
                        <option {{ $order->state == 17 ? 'selected' : '' }} value="17">جازان</option>
                        <option {{ $order->state == 18 ? 'selected' : '' }} value="18">جدة</option>
                        <option {{ $order->state == 24 ? 'selected' : '' }} value="24">المجمعة</option>
                        <option {{ $order->state == 31 ? 'selected' : '' }} value="31">الخبر</option>
                        <option {{ $order->state == 80 ? 'selected' : '' }} value="80">عنيزة</option>
                        <option {{ $order->state == 168 ? 'selected' : '' }} value="168">الارطاوية</option>
                        <option {{ $order->state == 227 ? 'selected' : '' }} value="227">الظهران</option>
                        <option {{ $order->state == 243 ? 'selected' : '' }} value="243">بقيق</option>
                        <option {{ $order->state == 253 ? 'selected' : '' }} value="253">صلاصل</option>
                        <option {{ $order->state == 270 ? 'selected' : '' }} value="270">الزلفي</option>
                        <option {{ $order->state == 306 ? 'selected' : '' }} value="306">الغاط</option>
                        <option {{ $order->state == 377 ? 'selected' : '' }} value="377">رابغ</option>
                        <option {{ $order->state == 443 ? 'selected' : '' }} value="443">ثادق</option>
                        <option {{ $order->state == 444 ? 'selected' : '' }} value="444">الروبضة / رغبة</option>
                        <option {{ $order->state == 796 ? 'selected' : '' }} value="796">ملهم</option>
                        <option {{ $order->state == 828 ? 'selected' : '' }} value="828">الدرعية</option>
                        <option {{ $order->state == 834 ? 'selected' : '' }} value="834">العمارية</option>
                        <option {{ $order->state == 990 ? 'selected' : '' }} value="990">المزاحمية</option>
                        <option {{ $order->state == 1061 ? 'selected' : '' }} value="1061">الخرج</option>
                        <option {{ $order->state == 1801 ? 'selected' : '' }} value="1801">محايل</option>
                        <option {{ $order->state == 2421 ? 'selected' : '' }} value="2421">الرس</option>
                        <option {{ $order->state == 2522 ? 'selected' : '' }} value="2522">يدمة</option>
                        <option {{ $order->state == 3417 ? 'selected' : '' }} value="3417">نجران</option>
                        <option {{ $order->state == 3479 ? 'selected' : '' }} value="3479">صبيا</option>
                        <option {{ $order->state == 3499 ? 'selected' : '' }} value="3499">ضمد</option>
                        <option {{ $order->state == 3525 ? 'selected' : '' }} value="3525">ابو عريش</option>
                        <option {{ $order->state == 3618 ? 'selected' : '' }} value="3618">البديع والقرفي</option>
                        <option {{ $order->state == 3652 ? 'selected' : '' }} value="3652">احد المسارحة</option>
                        <option {{ $order->state == 3677 ? 'selected' : '' }} value="3677">الاحساء</option>
                        <option {{ $order->state == 23695 ? 'selected' : '' }} value="23695">مدينة الملك عبدالله الاقتصادية</option>
                </select>
